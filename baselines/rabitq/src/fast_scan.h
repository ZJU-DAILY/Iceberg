...
// ==============================================================
inline void accumulate_one_block(size_t B, uint8_t* codes, uint8_t* LUT, uint16_t* result){
...
// ==============================================================
inline void accumulate(size_t B, size_t nblk, uint8_t* codes, uint8_t* LUT, uint16_t* result){
...
// ==============================================================
inline void pack_LUT(size_t B, uint8_t* byte_query, uint8_t* LUT){
    size_t M = B / 4;
    uint32_t pos[16]={
